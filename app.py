...
TURMAS_FIXAS = {
    ...
    "7º ano - Manhã": [
        ...
        "CLIMENIA ANGELICA E. FERNANDES DE OLIVEIRA",
        "ISABELLA LARISSA ALMEIDA LINO",
        "ISADORA RODRIGUES CARMO",
        "MANUELA ESTEVES PINHEIRO SANTOS",
        "MARIA EDUARDA SANTOS GARRIDO",
        "RAFAEL BERNARDO GUEDES",
        "SOFIA BARRETO DO NASCIMENTO REIS",
        "KAZUO",
    ],
